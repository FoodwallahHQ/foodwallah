                ...
                <div className="col-sm-12">
                  <div className="process-item-content">
                    <div className="content">
                      ...
                      <h5 className="legal-title">Interpretation and Definitions</h5 >
                      ...
                      <ul>
                        ...
                        <li>
                          <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to  Foodwallah, Inc, Chicago, IL.
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Website</strong> refers to  Foodwallah, accessible from https://www.foodwallah.com
                        </li>
                        <li>
                          <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
                        </li>
                      </ul>
                      <h5 className="legal-title">Collecting and Using Your Personal Data</h5 >
                      ...
                      <h5 className="legal-title">Children's Privacy</h5 >
